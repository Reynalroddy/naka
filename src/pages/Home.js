...
import lp2 from '../slider/naka.jpg'
  ...
  return (
    ...
    <header className="min-w-full text-gray-800 py-14 px-4 md:px-0">
      <div className="flex items-center container mx-auto max-w-5xl justify-between h-full">
        {/* Logo */}
        <a href="#">
            <img src={lp2} className='w-[140px] md:w-[170px] h-[100px]'/>
        ...
        <nav aria-label="Contact Menu">
          <ul className="flex items-center space-x-4 md:space-x-6">
            ...
            <li className="cursor-pointer">
              <a
                href="https://instagram.com/nakamigos.nft?igshid=MjEwN2IyYWYwYw=="
                target="_blank"
                rel="noreferrer"
              >
                {/* <svg
    ...
    <div className="h-full w-full container max-w-5xl mx-auto flex flex-col items-center pt-4">
      <div className="flex flex-col items-center max-w-4xl w-full">
        <Link to='/mint' >
          <span className="mt-16 font-coiny uppercase inline-flex items-center px-6 oy-2 text-sm sm:text-2xl md:text-3xl font-medium text-center rounded text-blue-500 hover:bg-blue-600 hover:text-white">
            Go to minting page
            <svg
              xmlns="http://www.w3.org/2000/svg"
